...
class Sns_Megamenu_Block_Adminhtml_Menuitems_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('group_name', array(
			...
			'index'     => 'group_name',
			'type'      => 'options',
			'options'   => Sns_Megamenu_Model_System_Config_Source_ListGroup::getOptionArray(),	
